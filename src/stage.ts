...
export function generate(archetype: any, baseParams: any, archetypeParams: any) {
  origin = view.center;
...
export function model(baseParams: any, archetypeParams: any) {
  origin = view.center;
...
export function regenerate(baseParams: any, archetypeParams: any) {
  origin = view.center;
